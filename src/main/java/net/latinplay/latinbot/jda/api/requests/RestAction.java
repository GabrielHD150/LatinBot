...
import net.latinplay.latinbot.jda.api.utils.concurrent.DelayedCompletableFuture;
import net.latinplay.latinbot.jda.internal.requests.RestActionImpl;
import net.latinplay.latinbot.jda.internal.requests.restaction.operator.DelayRestAction;
import net.latinplay.latinbot.jda.internal.requests.restaction.operator.FlatMapRestAction;
import net.latinplay.latinbot.jda.internal.requests.restaction.operator.MapRestAction;
import net.latinplay.latinbot.jda.internal.utils.Checks;
import net.latinplay.latinbot.jda.internal.utils.ContextRunnable;
 ...
 * <pre><code>
 *      {@link MessageChannel MessageChannel} channel = event.getChannel();
...
{
    /**
     * If enabled this will pass a {@link ContextException ContextException}
    ...
    /**
     * Whether RestActions will use {@link ContextException ContextException}
     ...
     * @see MessageAction MessageAction
    ...
    default <O> RestAction<O> map( Function<? super T, ? extends O> map)
    {
    ...
    default <O> RestAction<O> flatMap( Function<? super T, ? extends RestAction<O>> flatMap)
    {
    ...
    default <O> RestAction<O> flatMap(Predicate<? super T> condition,  Function<? super T, ? extends RestAction<O>> flatMap)
    {
    ...
    default RestAction<T> delay( Duration duration)
    {
    ...
    default RestAction<T> delay( Duration duration, ScheduledExecutorService scheduler)
    {
    ...
    default RestAction<T> delay(long delay,  TimeUnit unit)
    {
    ...
    default RestAction<T> delay(long delay,  TimeUnit unit, ScheduledExecutorService scheduler)
    {
