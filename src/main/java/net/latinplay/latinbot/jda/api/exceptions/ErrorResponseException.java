...
public class ErrorResponseException extends RuntimeException
{
    ...
    public static Consumer<Throwable> ignore( ErrorResponse ignored,  ErrorResponse... errorResponses)
    {
    ...
    public static Consumer<Throwable> ignore( Consumer<? super Throwable> orElse,  ErrorResponse ignored,  ErrorResponse... errorResponses)
    {
