...
import net.latinplay.latinbot.jda.api.events.GatewayPingEvent;
import net.latinplay.latinbot.jda.api.events.guild.GuildAvailableEvent;
import net.latinplay.latinbot.jda.api.events.guild.GuildJoinEvent;
import net.latinplay.latinbot.jda.api.events.guild.GuildUnavailableEvent;
import net.latinplay.latinbot.jda.api.events.message.MessageBulkDeleteEvent;
import net.latinplay.latinbot.jda.api.events.message.MessageDeleteEvent;
import net.latinplay.latinbot.jda.api.exceptions.AccountTypeException;
import net.latinplay.latinbot.jda.api.hooks.AnnotatedEventManager;
...
import net.latinplay.latinbot.jda.api.managers.DirectAudioController;
...
public interface JDA
{
    ...
    default JDA awaitStatus(JDA.Status status) throws InterruptedException
    {
    ...
    JDA awaitStatus(JDA.Status status, JDA.Status... failOn) throws InterruptedException;
