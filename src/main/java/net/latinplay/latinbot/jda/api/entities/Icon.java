...
public class Icon
{
    ...
    protected Icon( IconType type,  String base64Encoding)
    {
    ...
    public static Icon from( File file,  IconType type) throws IOException
    {
        Checks.notNull(file, "Provided File");
    ...
    public static Icon from( InputStream stream,  IconType type) throws IOException
    {
    ...
    public static Icon from( byte[] data,  IconType type)
    {
    ...
    public enum IconType
    {
        ...
        public static IconType fromMIME( String mime)
        {
        ...
        public static IconType fromExtension( String extension)
        {
