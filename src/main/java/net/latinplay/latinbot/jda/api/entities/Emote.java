...
public interface Emote extends IMentionable, IFakeable
{
     ...
     * <ul>
     *     <li>{@link ErrorResponse#UNKNOWN_EMOJI UNKNOWN_EMOTE}
     ...
     *         if the Permission {@link Permission#MANAGE_EMOTES MANAGE_EMOTES} is not given
     *
     ...
     * @throws InsufficientPermissionException
     *         If the currently logged in account does not have {@link Permission#MANAGE_EMOTES Permission.MANAGE_EMOTES}
     *
