...
import net.latinplay.latinbot.jda.api.utils.cache.ShardCacheView;
...
public interface ShardManager
{
    ...
    /**
     * This returns the {@link JDA.Status JDA.Status} of the shard which has the same id as the one provided.
     * <br>If there is no shard with an id that matches the provided one, then this returns {@code null}.
     *
     * @param  shardId
     *         The id of the shard.
     *
     * @return The {@link JDA.Status JDA.Status} of the shard with the given shardId or
     *         {@code null} if no shard has the given id
     */
    ...
    default StoreChannel getStoreChannelById(final String id)
    {
        return this.getStoreChannelCache().getElementById(id);
    }
     ...
     * @see    Activity#streaming(String, String)
     */
    default void setActivity( final Activity activity)
    {
     ...
     * @see    Activity#streaming(String, String)
     */
    default void setActivityProvider( final IntFunction<? extends Activity> activityProvider)
    {
     ...
     * @see    Activity#streaming(String, String)
     */
    default void setPresence( final OnlineStatus status,  final Activity activity)
    {
     ...
     * @see    Activity#streaming(String, String)
     */
    default void setPresenceProvider( final IntFunction<OnlineStatus> statusProvider,  final IntFunction<? extends Activity> activityProvider)
    {
