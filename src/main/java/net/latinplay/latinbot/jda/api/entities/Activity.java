...
public interface Activity
{
     ...
     *
     * @return Never-null {@link Activity.ActivityType ActivityType} representing the type of Activity
     */
     ...
     *
     * @return {@link Activity.Timestamps Timestamps} wrapper of {@code null} if unset
     */
     ...
     *
     * @return A valid Activity instance with the provided name with {@link Activity.ActivityType#DEFAULT}
     */
     ...
     *         if the specified name is null, empty or blank
     *
     * @return A valid Activity instance with the provided name with {@link Activity.ActivityType#LISTENING}
     */
     ...
     *         if the specified name is null, empty or blank
     *
     * @return A valid Activity instance with the provided name with {@link Activity.ActivityType#WATCHING}
     *
     ...
     *
     * @param  type
     *         The {@link Activity.ActivityType ActivityType} to use
     * @param  name
     *         The not-null name of the newly created game
     *
     * @throws IllegalArgumentException
    ...
    /**
     * Creates a new Activity instance with the specified name and url.
     * <br>The provided url would only be used for {@link Activity.ActivityType#STREAMING ActivityType.STREAMING}
