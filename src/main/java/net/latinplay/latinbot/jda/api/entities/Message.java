...
import net.latinplay.latinbot.jda.api.exceptions.HttpException;
...
import net.latinplay.latinbot.jda.internal.requests.FunctionalCallback;
 ...
 * as {@link MessageUpdateEvent MessageUpdateEvent} and similar.</b>
 *
...
public interface Message extends ISnowflake, Formattable
{
     ...
     *
     * @see MessageAction#addFile(java.io.File, AttachmentOption...) MessageAction.addFile(...)
     */
    ...
    /**
     * A immutable list of all mentioned {@link TextChannel TextChannels}.
     * <br>If none were mentioned, this list is empty. Elements are sorted in order of appearance.
     *
     * <p><b>This may include TextChannels from other {@link Guild Guilds}</b>
     *
     * @throws java.lang.UnsupportedOperationException
     *         If this is not a Received Message from {@link MessageType#DEFAULT MessageType.DEFAULT}
     *
    ...
    /**
     * A immutable list of all mentioned {@link Role Roles}.
     ...
     * counts direct mentions of the role and not mentions through the everyone tag.
     * If a role is not {@link Role#isMentionable() mentionable} it will not be included.
     *
     * <h2>Example</h2>
     * <pre>{@code
     * public void sendCount(Message msg)
    ...
    /**
     * Creates an immutable list of {@link Member Members}
     ...
     * {@link Guild Guild} this Message was sent in.
     ...
     *         If this message was not sent in a {@link TextChannel TextChannel}
     *
     * @return Immutable list of mentioned Members
     *
     * @since  3.4.0
     ...
     *
     * @param  types
     *         Amount of {@link Message.MentionType MentionTypes}
     ...
     * <br>This is just a shortcut to {@link #getGuild()}{@link Guild#getMember(User) .getMember(getAuthor())}.
     ...
     * <br>Equivalent to {@code getTextChannel().getParent()} if this was sent in a {@link TextChannel}.
     *
     * @throws java.lang.UnsupportedOperationException
     *         If this is not a Received Message from {@link MessageType#DEFAULT MessageType.DEFAULT}
     *
    ...
    /**
     * All {@link Emote Emotes} used in this Message.
     ...
     *     <br>The edit was attempted after the account lost {@link Permission#MESSAGE_WRITE Permission.MESSAGE_WRITE} in
    ...
    /**
     * Edits this Message's content to the provided {@link MessageEmbed MessageEmbed}.
     * <br><b>Messages can only be edited by the account that sent them!</b>.
     *
     * <p>This message instance will not be updated by this operation, please use the response message instead.
     *
     ...
     *         or not {@link MessageEmbed#isSendable(AccountType) sendable}
     *
     * @return {@link MessageAction MessageAction}
     *         <br>The {@link Message Message} with the updated content
     */
     ...
     *                 {@link MessageEmbed#isSendable(AccountType) sendable}</li>
     *         </ul>
     *
     * @return {@link MessageAction MessageAction}
     *         <br>The {@link Message Message} with the updated content
     ...
     * a {@link TextChannel TextChannel} and the current account has
     ...
     * <ul>
     *     <li>{@link ErrorResponse#MISSING_ACCESS MISSING_ACCESS}
     *     <br>The delete was attempted after the account lost access to the {@link TextChannel TextChannel}
     ...
     *         the {@link TextChannel TextChannel} when deleting another Member's message
     ...
     *         {@link TextChannel TextChannel}, and the currently logged in account
     ...
     * <ul>
     *     <li>{@link ErrorResponse#MISSING_ACCESS MISSING_ACCESS}
     *     <br>The unpin request was attempted after the account lost access to the {@link TextChannel TextChannel}
     *         due to {@link Permission#MESSAGE_READ Permission.MESSAGE_READ} being revoked, or the
     *         account lost access to the {@link Guild Guild}
     *         typically due to being kicked or removed.</li>
     *
     ...
     * <ul>
     *     <li>{@link ErrorResponse#MISSING_ACCESS MISSING_ACCESS}
     *     <br>The reaction request was attempted after the account lost access to the {@link TextChannel TextChannel}
     *         due to {@link Permission#MESSAGE_READ Permission.MESSAGE_READ} being revoked
     ...
     *             <li>If the provided {@link Emote Emote} is fake {@link Emote#isFake() Emote.isFake()}.</li>
     ...
     *         in the {@link TextChannel TextChannel} when removing the reaction.</li>
     *
     *     <li>{@link ErrorResponse#UNKNOWN_MESSAGE UNKNOWN_MESSAGE}
     *         The reaction request was attempted after the Message had been deleted.</li>
     * </ul>
     ...
     *         If this is not a Received Message from {@link MessageType#DEFAULT MessageType.DEFAULT}
     * @throws InsufficientPermissionException
     *         If the MessageChannel this message was sent in was a {@link TextChannel TextChannel} and the
    ...
    /**
     * This obtains the {@link MessageReaction.ReactionEmote ReactionEmote} for the given unicode reaction on this message.
     *
     * <p>Messages also store reactions using unicode values.
     *
     * <p>An instance of the related {@link MessageReaction.ReactionEmote ReactionEmote} can be
     ...
     * <ul>
     *     <li>{@link ErrorResponse#MISSING_ACCESS MISSING_ACCESS}
     *     <br>The request was attempted after the account lost access to the {@link TextChannel TextChannel}
     *         due to {@link Permission#MESSAGE_READ Permission.MESSAGE_READ} being revoked
     *     <br>Also can happen if the account lost the {@link Permission#MESSAGE_HISTORY Permission.MESSAGE_HISTORY}</li>
     *
     *     <li>{@link ErrorResponse#UNKNOWN_MESSAGE UNKNOWN_MESSAGE}
     ...
     *
     * @return The {@link MessageReaction.ReactionEmote ReactionEmote} of this message or null if not present.
     *
     * @since  4.1.0
     */
    
    
    MessageReaction.ReactionEmote getReactionByUnicode( String unicode);

    /**
     * This obtains the {@link MessageReaction.ReactionEmote ReactionEmote} for the given reaction id on this message.
     *
    ...
    enum MentionType
    {
        ...
        ROLE("<@&(\\d+)>"),
        /**
         * Represents a mention for a {@link TextChannel TextChannel}
         * <br>The first and only group matches the id of the mention.
         */
        CHANNEL("<#(\\d+)>"),
        /**
    ...
    class Attachment implements ISnowflake
    {
         ...
         * <br>Useful with {@link AccountManager#setAvatar(Icon)}.
         * <br>This will download the file using the {@link JDA#getCallbackPool() callback pool}.
         * Alternatively you can use {@link #retrieveInputStream()} and use a continuation with a different executor.
         *
         * <h2>Example</h2>
         ...
         *
         * @return {@link java.util.concurrent.CompletableFuture} - Type: {@link Icon}
         */
