...
public interface AudioReceiveHandler
{
    ...
    /**
     * If {@link #canReceiveEncoded()} returns true, JDA will provide raw {@link OpusPacket OpusPackets}
     ...
     *
     * <p>This is useful for systems that want to either do lazy decoding of audio through {@link OpusPacket#getAudioData(double)}
    ...
    /**
     * If {@link #canReceiveCombined()} returns true, JDA will provide a {@link CombinedAudio CombinedAudio}
     ...
     * <br>and is defined by: {@link AudioReceiveHandler#OUTPUT_FORMAT AudioRecieveHandler.OUTPUT_FORMAT}
     *
     * @param  combinedAudio
    ...
    /**
     * If {@link #canReceiveUser()} returns true, JDA will provide a {@link UserAudio UserAudio}
     ...
     * <p>
     * The {@link UserAudio UserAudio} object provided to this method will contain the
     * {@link User User} that spoke along with <b>only</b> the audio data sent by the specific user.
     * <p>
     ...
     * {@link User User}'s audio when creating a CombinedAudio packet.
     * <p>
