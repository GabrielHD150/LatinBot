...
/**
 * Represents the connection between a {@link IAudioSendSystem IAudioSendSystem} and
...
public interface IPacketProvider
{
     ...
     *
     * @return The {@link VoiceChannel VoiceChannel} that this connection is sending to.
     */
    
    VoiceChannel getConnectedChannel();

    /**
     * The UDP connection for this audio connection. The {@link DefaultSendSystem DefaultSendSystem}
     ...
     * {@link AudioSendHandler AudioSendHandler} cannot provide an audio packet.
     ...
     *
     * @param  status
     *         The {@link ConnectionStatus ConnectionStatus} being reported to JDA
     ...
     * {@link #onConnectionError(ConnectionStatus)} as it provides a default error
     * reason of {@link ConnectionStatus#ERROR_LOST_CONNECTION}.
     */
