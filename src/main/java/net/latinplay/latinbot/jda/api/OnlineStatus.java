...
/**
 * Represents the online presence of a {@link Member Member}.
 */
public enum OnlineStatus
{
     ...
     * <br>Other {@link Member Members} will show up as {@link OnlineStatus#OFFLINE OFFLINE} even when they really are INVISIBLE.
     */
    INVISIBLE("invisible"),
    /**
    ...
    /**
     * Will get the {@link OnlineStatus OnlineStatus} from the provided key.
     * <br>If the provided key does not have a matching OnlineStatus, this will return {@link OnlineStatus#UNKNOWN UNKONWN}
     *
     * @param  key
     *         The key relating to the {@link OnlineStatus OnlineStatus} we wish to retrieve.
     *
     * @return The matching {@link OnlineStatus OnlineStatus}. If there is no match, returns {@link OnlineStatus#UNKNOWN UNKNOWN}.
     */
