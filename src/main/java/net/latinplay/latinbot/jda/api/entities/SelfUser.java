...
public interface SelfUser extends User
{
     ...
     * <br><b>NOTE:</b> this is a {@link AccountType#CLIENT AccountType.CLIENT} method only!
     *
     * @throws AccountTypeException
     *         If this method is called when {@link JDA#getAccountType() JDA#getAccountType()} does not return
     *         {@link AccountType#CLIENT AccountType.CLIENT}. E.g: If the logged in account isn't a Client account!
     *
     ...
     * <br>Returns {@value Message#MAX_FILE_SIZE} for bots and non-nitro client accounts
     * and {@value Message#MAX_FILE_SIZE_NITRO} for client accounts with a active nitro subscription.
     * 
     * @return The maximum size for files that can be uploaded with this account
     * 
     * @see Message#MAX_FILE_SIZE
     * @see Message#MAX_FILE_SIZE_NITRO
     */
