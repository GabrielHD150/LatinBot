...
import net.latinplay.latinbot.jda.api.audio.OpusPacket;
    ...
    public void start()
    {
        ...
        sendThread = new Thread(() ->
        {
            ...
            while (!udpSocket.isClosed() && !sendThread.isInterrupted())
            {
                try
                {
                    boolean changeTalking = !sentPacket || (System.currentTimeMillis() - lastFrameSent) > OpusPacket.OPUS_FRAME_TIME_AMOUNT;
