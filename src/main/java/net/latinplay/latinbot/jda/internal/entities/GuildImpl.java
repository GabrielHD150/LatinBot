...
import net.latinplay.latinbot.jda.internal.managers.GuildManagerImpl;
import net.latinplay.latinbot.jda.internal.requests.*;
import net.latinplay.latinbot.jda.internal.requests.restaction.AuditableRestActionImpl;
import net.latinplay.latinbot.jda.internal.requests.restaction.ChannelActionImpl;
import net.latinplay.latinbot.jda.internal.requests.restaction.MemberActionImpl;
import net.latinplay.latinbot.jda.internal.requests.restaction.RoleActionImpl;
import net.latinplay.latinbot.jda.internal.requests.restaction.order.CategoryOrderActionImpl;
import net.latinplay.latinbot.jda.internal.requests.restaction.order.ChannelOrderActionImpl;
import net.latinplay.latinbot.jda.internal.requests.restaction.order.RoleOrderActionImpl;
import net.latinplay.latinbot.jda.internal.requests.restaction.pagination.AuditLogPaginationActionImpl;
import net.latinplay.latinbot.jda.internal.utils.*;
import net.latinplay.latinbot.jda.internal.utils.cache.AbstractCacheView;
import net.latinplay.latinbot.jda.internal.utils.cache.MemberCacheViewImpl;
...
public class GuildImpl implements Guild
{
    ...
    private AuditableRestAction<Void> kick0( String userId,  String reason)
    {
    ...
    private AuditableRestAction<Void> ban0( String userId, int delDays, String reason)
    {
