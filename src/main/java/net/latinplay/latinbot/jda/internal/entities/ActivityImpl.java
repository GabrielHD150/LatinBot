...
import net.latinplay.latinbot.jda.api.entities.RichPresence;
...
public class ActivityImpl implements Activity
{
    ...
    protected ActivityImpl(String name, String url, ActivityType type, Timestamps timestamps, Emoji emoji)
    {
        this.name = name;
        this.url = url;
        this.type = type;
