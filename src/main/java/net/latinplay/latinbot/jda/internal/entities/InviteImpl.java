...
public class InviteImpl implements Invite
{
    ...
    public RestAction<Invite> expand()
    {
        ...
        final net.latinplay.latinbot.jda.api.entities.Guild guild = this.api.getGuildById(this.guild.getIdLong());
    ...
    public static class GuildImpl implements Guild
    {
        ...
        private final long id;
        private final net.latinplay.latinbot.jda.api.entities.Guild.VerificationLevel verificationLevel;
        private final Set<String> features;

        public GuildImpl(final long id, final String iconId, final String name, final String splashId,
                         final net.latinplay.latinbot.jda.api.entities.Guild.VerificationLevel verificationLevel, final int presenceCount, final int memberCount, final Set<String> features)
        {
            this.id = id;
            this.iconId = iconId;
            this.name = name;
        ...
        @Override
        public net.latinplay.latinbot.jda.api.entities.Guild.VerificationLevel getVerificationLevel()
        {
