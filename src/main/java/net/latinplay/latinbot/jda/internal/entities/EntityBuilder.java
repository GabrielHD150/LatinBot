...
import net.latinplay.latinbot.jda.api.audit.AuditLogChange;
import net.latinplay.latinbot.jda.api.audit.AuditLogEntry;
import net.latinplay.latinbot.jda.api.entities.*;
import net.latinplay.latinbot.jda.api.events.guild.member.GuildMemberRoleAddEvent;
import net.latinplay.latinbot.jda.api.events.guild.member.GuildMemberRoleRemoveEvent;
...
import net.latinplay.latinbot.jda.api.events.user.update.UserUpdateAvatarEvent;
import net.latinplay.latinbot.jda.api.events.user.update.UserUpdateDiscriminatorEvent;
import net.latinplay.latinbot.jda.api.events.user.update.UserUpdateNameEvent;
...
import net.latinplay.latinbot.jda.internal.handle.EventCache;
import net.latinplay.latinbot.jda.internal.utils.JDALogger;
import net.latinplay.latinbot.jda.internal.utils.UnlockHook;
...
public class EntityBuilder
{
    ...
    public GuildImpl createGuild(long guildId, DataObject guildJson, TLongObjectMap<DataObject> members, int memberCount)
    {
        ...
        guildObj.setAvailable(true)
                ...
                .setVerificationLevel(Guild.VerificationLevel.fromKey(verificationLevel))
