...
import net.latinplay.latinbot.jda.api.events.message.MessageEmbedEvent;
import net.latinplay.latinbot.jda.api.events.message.MessageUpdateEvent;
import net.latinplay.latinbot.jda.api.events.message.guild.GuildMessageEmbedEvent;
import net.latinplay.latinbot.jda.api.events.message.guild.GuildMessageUpdateEvent;
import net.latinplay.latinbot.jda.api.events.message.priv.PrivateMessageEmbedEvent;
import net.latinplay.latinbot.jda.api.events.message.priv.PrivateMessageUpdateEvent;
