...
import net.latinplay.latinbot.jda.api.events.user.update.UserUpdateActivityOrderEvent;
import net.latinplay.latinbot.jda.api.events.user.update.UserUpdateOnlineStatusEvent;
