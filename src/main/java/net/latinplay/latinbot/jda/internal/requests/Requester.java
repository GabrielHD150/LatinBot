...
import net.latinplay.latinbot.jda.api.JDAInfo;
...
import net.latinplay.latinbot.jda.internal.requests.ratelimit.BotRateLimiter;
import net.latinplay.latinbot.jda.internal.requests.ratelimit.ClientRateLimiter;
