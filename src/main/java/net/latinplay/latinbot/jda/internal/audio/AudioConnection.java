...
package net.latinplay.latinbot.jda.internal.audio;
...
import net.latinplay.latinbot.jda.api.audio.*;
...
import net.latinplay.latinbot.jda.api.audio.factory.IPacketProvider;
